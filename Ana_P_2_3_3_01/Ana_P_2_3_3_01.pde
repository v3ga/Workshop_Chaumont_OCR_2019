...
// ----------------------------------------------------------------
String backgroundImageName = "Ana_map.png";
String fontName = "American Typewriter";
float alphaBackgroundImage = 50; // 0  - 255
...
void setup() {
  ...
  // load an image in background
   PImage img = loadImage(backgroundImageName);
   pushStyle();
   tint(255,alphaBackgroundImage);
